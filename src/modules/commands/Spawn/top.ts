...
export default class Spawn extends Command {
    ...
    private async map<T extends Lava.CurrencyProfile | Lava.SpawnDocument>(docs: (mongoose.Document & T)[], amount: number, key: string): Promise<Promise<string>[]> {
    ...
    public async exec(_: Message, args: any): Promise<Message> {
        ...
        embed.setDescription((await Promise.all(mapped)).join('\n')).setColor('RANDOM');
