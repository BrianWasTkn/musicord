...
const qObj = {
  ...
  event: {
    ...
    Winners:
      "If your type of event requires a giveaway bot, please tell us the number of winners. Type none if it isn't.",
    Donation:
      'What do you want the winners to recieve? Any items or coin amount.',
  },
  heist: {
