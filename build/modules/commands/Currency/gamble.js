...
const discord_akairo_1 = __importDefault(require("discord-akairo"));
class Currency extends discord_akairo_1.default.Command {
    constructor() {
        super('bet', {
            ...
            args: [{
                    id: 'amount',
                    type: discord_akairo_1.default.Argument.union('number', 'string')
                }]
        });
    }
    async exec(_, args) {
        ...
        // Visuals and DB
        let winnings, won, percentWon, description, identifier, db, color;
        if (userD > botD) {
            // Win
